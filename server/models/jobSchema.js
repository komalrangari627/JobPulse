...
const jobSchema = new mongoose.Schema({
  ...
  jobCreatedBy: { type: mongoose.Schema.Types.ObjectId, ref: "companies", required: true },
  jobRequirements: { type: jobRequirementsSchema, required: true },
  applications: [{ type: mongoose.Schema.Types.ObjectId, ref: "users" }],
